...
var resizePizzas = function(size) { 
  ...
  function determineDx (elem, size) {
    ...
    //console.log(dx);
    //calculated the newwidth in determineDx instead of changePizzaSizes()
  ...
  function changePizzaSizes(size) {
    for (var i = 0; i < document.querySelectorAll(".randomPizzaContainer").length; i++) {
      var newwidth = determineDx(document.getElementsByClassName("randomPizzaContainer")[i], size) + 'px';;
      // console.log(dx);
